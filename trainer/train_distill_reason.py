...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-Distill-Reasoning")
    ...
    args.wandb_run_name = f"MiniMind-Distill-Reasoning-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}-Hidden_size-{args.hidden_size}-Num_hidden_layers-{args.num_hidden_layers}"
