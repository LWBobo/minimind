...
if __name__ == "__main__":
    ...
    args.wandb_run_name = f"MiniMind-Full-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}-Hidden_size-{args.hidden_size}-Num_hidden_layers-{args.num_hidden_layers}"
